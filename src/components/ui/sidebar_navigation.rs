...
use crate::components::base::sidebar::{
    Sidebar, SidebarCollapsible, SidebarContent, SidebarGroup, SidebarGroupLabel,
    SidebarHeader, SidebarMenu, SidebarMenuButton, SidebarMenuItem, SidebarMenuSub,
    SidebarMenuSubButton, SidebarMenuSubItem, SidebarVariant,
};
use leptos::prelude::*;
...
pub fn SideNav() -> impl IntoView {
    ...
    let has_permission = move |required_permissions: &[&str]| {
                        ...
                        <SidebarGroup class=group_class.to_string()>
                            ...
                            <SidebarMenu>
                                {group.items.into_iter()
                                    .filter(|item| has_permission(&item.permissions))
                                    .map(|item| {
                                                    ...
                                                    view! {
                                                        <Collapsible default_open=default_open class="group/collapsible".to_string()>
                                                            <CollapsibleTrigger as_child=true>
                                                                <SidebarMenuButton
                                                                    class=move || {
                                                                        let active_class = if is_parent_active {
                                                            ...
                                                            <CollapsibleContent>
                                                                <SidebarMenuSub>
                                                                    {sub_items.into_iter()
                                                                        .filter(|sub_item| has_permission(&sub_item.permissions))
                                                                        .map(|sub_item| {
